...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sample_meta_data = sample_number[0];
    console.log(sample_meta_data);

    // Create variables that hold the otu_ids, otu_labels, and sample_values.

    // 3. Create a variable that holds the washing frequency.
    var wash_frequency = result.wfreq
    var wash_frequency_float = parseFloat(wash_frequency).toFixed(2)
    console.log(wash_frequency_float)
    ...
    var gauge_layout = { 
      ...
      titlefont:{"size":20, family='Arial Black'}
